...
- `sf` spatial point, line, and polygon types can be read from or written to NetCDF-CF geometry variables introduced in CF-1.8
...
For more information about the polygon and timeseries data structures used here, see the [NetCDF-CF standard.](https://cfconventions.org/cf-conventions/cf-conventions.html)  
