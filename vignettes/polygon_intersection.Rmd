...
if(!requireNamespace("hydrogeofetch", quietly = TRUE)) {
  warning("need hydrogeofetch for this demo")
...
[It is a comparison with the `gdptools` python package demonstration here.](https://gdptools.readthedocs.io/en/develop/Examples/PolyToPoly/Extensive_vs_intensive_variables.html)
